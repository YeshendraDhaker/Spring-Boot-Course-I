...
In continuation of your vaccine application, there is a change where you have to implement the dependency injection using a setter method. Modify the project based on the following:
